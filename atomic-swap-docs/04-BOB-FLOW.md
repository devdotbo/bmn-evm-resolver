...
Bob is the swap acceptor who monitors for Alice's swap offers, evaluates them, and completes the atomic swap by creating a matching HTLC on the destination chain.
